...
infile <- "/Users/chico/projects/doutorado_tarcisio_final/bin/SIGNATURES/hosts/tmp/RSCU_files/final_results_RSCU_minus_stop_monocodonic.txt"
...
pdf(file="host_RSCU_corrplot.pdf", width=10, height=10)

x <- acast(x_3, GENOME~CODON_PLUS_AA, value.var="NORM")
corr <- cor(x)
